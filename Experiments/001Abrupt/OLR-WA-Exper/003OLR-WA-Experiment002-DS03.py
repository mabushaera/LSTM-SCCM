...
from Datasets.SyntheticDS.Abrupt import DS03
...
def TB_Experiment01(X_train, y_train, X_test, y_test):
    ...
    olr_wa_acc, olr_wa_acc_list = OLR_WA.olr_wa_regression_adversarial_fixed_hyperparameters(X_train, y_train,
                                                                                             ...
                                                                                             Hyperparameter.olr_wa_increment_size2(
                                                                                                 n_features,
                                                                                                 user_defined_val=10),
                                                                                             X_test,
                                                                                             y_test)
    ...
    if (plotting_enabled):
        ...
        label1 = 'OLR-WA'
        label2 = 'OLR-WA$^*$'
        Plotter.plot_results(x_axis, y_axis1, y_axis2, kpi, label1, label2, drift_location=10000, log_enabled=True,
                             legend_loc='lower left',
                             drift_type='abrupt', gradual_drift_concepts=None, gradual_drift_locations=None)
