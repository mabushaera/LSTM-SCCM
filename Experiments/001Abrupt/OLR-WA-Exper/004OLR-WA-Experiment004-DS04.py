...
from Datasets.SyntheticDS.Abrupt import DS04
...
def TB_Experiment01(X_train, y_train, X_test, y_test):
    ...
    if (plotting_enabled):
        ...
        label1 = 'OLR-WA'
        label2 = 'OLR-WA$^*$'
        Plotter.plot_results(x_axis, y_axis1, y_axis2, kpi, label1, label2, drift_location=50000, log_enabled=True,
                             legend_loc='lower left'
                             , drift_type='abrupt', gradual_drift_locations=None, gradual_drift_concepts=None)
